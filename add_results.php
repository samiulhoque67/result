    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="dept" id="" placeholder="dept">
                <input type="text" name="rno" placeholder="ID">
                <input type="text" name="p1" id="" placeholder="">
                <input type="text" name="ps2" id="" placeholder="Paper 2">
